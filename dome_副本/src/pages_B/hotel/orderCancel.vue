	...
	<view class="cancel-order" :data-theme="pageTheme" >
		<u-sticky bgColor="transparent" z-index="99999">
			<view class="searchView">
				<up-navbar title="取消订单" bgColor="transparent" @leftClick="toBack" placeholder :fixed="true"></up-navbar>
			</view>
		</u-sticky>
		<view class="form">
		...
		<view class="bottom-bar">
			<view class="bar-left">
				<!-- <view class="amount">
					...
					<text class="price">136</text>
				</view>
				<text class="refund">退款金额</text> -->
			</view>
			<view class="cancel-button" @click="handleCancelOrder">取消订单</view>
		</view>
	</view>
</template>
