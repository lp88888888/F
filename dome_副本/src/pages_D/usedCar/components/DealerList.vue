...
<template>
	<view :data-theme="pageTheme" >
		<view v-for="(item,index) in list" :key="index">
			<view class="card">
				<view class="card-center" @click="toNav('/pages_D/usedCar/merchantsDetail?id='+item.id)">
...
<style lang="scss" scoped>
	.card{
		...
		.card-btons{
			...
			.bton1{background: rgba(147,83,0,0.1);color: #492900;}
			.bton2{background: rgba(255,144,0,0.3);color: #492900;}
			.bton3{background: var(--but-color-line);color: #FFFFFF;}
		}
	}
