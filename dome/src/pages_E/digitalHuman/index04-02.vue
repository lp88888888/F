					...
					pieces.forEach(chunk => {
						...
						try {
							...
							chatStore.setServiceQueryMessage({
								...
								code: msg.code,
								cot: msg.data.cot,
								msgText: msg.data.answer ? msg.data.answer : '',
								answer: msg.data.answer ? msg.data.answer : '',
								aiData: msg.data.data || null
							})
							if (msg.code != 100) {
